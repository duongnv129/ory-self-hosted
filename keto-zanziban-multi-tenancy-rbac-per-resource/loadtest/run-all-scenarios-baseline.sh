...
node run-tests.js --scenario scenario1 --profile baseline --verbose

echo ""
echo "👥 Scenario 2: Authorization Patterns..."
node run-tests.js --scenario scenario2 --profile baseline --verbose

echo ""
echo "🔧 Scenario 3: Resource Type Scaling..."
node run-tests.js --scenario scenario3 --profile baseline --verbose

echo ""
echo "🏗️ Scenario 4: Hierarchical Inheritance..."
node run-tests.js --scenario scenario4 --profile baseline --verbose
